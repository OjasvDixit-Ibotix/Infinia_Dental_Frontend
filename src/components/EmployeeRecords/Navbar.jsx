...
const Navbar = () => {
  return (
    <div className="inline-flex h-10 px-4 sm:px-[12px] py-[9px] justify-center items-center gap-2 sm:gap-[8px] flex-shrink-0 rounded-[6px] border border-[#EFCD78] bg-white m-4 sm:m-6">
