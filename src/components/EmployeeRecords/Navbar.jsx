...
const Navbar = () => {
  ...
  return (
    <div className="inline-flex h-10 px-2 sm:px-4 py-2 justify-center items-center gap-1 sm:gap-2 flex-shrink-0 rounded-[6px] border border-[#EFCD78] bg-white cursor-pointer mt-2 mb-4 w-fit" onClick={()=>navigate('/dashboard')}>
