...
const EmployeeHeader = () => {
  ...
  return (
    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center   pt-4 sm:pt-6">
      ...
      <button onClick={() => setAddEmp(true)} className="mt-4 sm:mt-0 inline-flex items-center gap-2 px-4 py-2 sm:px-[17px] sm:py-[9px] bg-[#EFCD78] rounded-[6px] border border-[#EFCD78] hover:bg-[#e6c25c] transition text-[#444] text-[14px] leading-[20px] font-[Segoe UI Symbol]">
