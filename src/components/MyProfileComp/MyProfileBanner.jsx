    ...
    <div className="relative self-stretch rounded-3xl border mt-5 border-[#E8EAED] bg-white shadow-[0_8px_32px_-8px_rgba(40,44,52,0.1)]">     
      ...
      <div className="relative z-10 flex h-[158px] items-center gap-6 self-stretch p-8">
        ...
        <div className="flex flex-col items-start  ">
          <h2 className="text-2xl fontSans ">Priya Sharma</h2>
          <p className="text-[#444] fontSans">HR Aminstrator</p>
          <p className="text-[#444] fontSans">Human Resource Manager</p>
          <p className="text-[#444] fontSans">Employee ID: ID-2024-001</p>
        </div>
      </div>
    </div>
  );
