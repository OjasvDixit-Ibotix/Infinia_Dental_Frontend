  ...
  return (
    <div className="flex flex-col gap-6 self-stretch bg-white p-6 rounded-2xl border border-solid border-[#e8eaed]">
      <div className="w-full flex items-center gap-2">
        <span className="font-normal text-2xl text-[#444444]">Employment Details</span>
      </div> 
      <div className="self-stretch grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
        ...
        <div className="flex flex-col gap-1">
          <div className="flex items-center gap-2 self-stretch">
            <WorkLocationIcon />
            <span className="font-normal text-sm text-[#646e82]">Shift Timing</span>
          </div>
          <div className="pt-1 pl-6">
            <span className="font-normal text-base text-[#444444]">09:00AM - 06:00PM</span>
          </div>
        </div>
      </div>
    </div>
