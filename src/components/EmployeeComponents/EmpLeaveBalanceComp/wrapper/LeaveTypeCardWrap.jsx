...
const LeaveTypeCardWrap = ({logo, typeofLeave, available,used,usage,total}) => {
  return (
    ...
    <div className="flex flex-col justify-between self-stretch w-[206px] h-[276px] bg-white rounded-2xl p-6">
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="flex justify-between items-center self-stretch">
          <span className="font-normal text-[13.5625px] leading-[20px] text-gray-600">
            Total
          </span>
