...
const leaveHistoryData = [
  ...
  { id: 4, date: "May 28, 2024", leaveType: "Annual Leave", duration: "2 days", status: "Rejected", remarks: "Extended weekend" },
...
function LeaveHistorySection() {
  return (
    <div className="flex flex-col  gap-5 self-stretch w-full  bg-white p-6 rounded-2xl shadow-sm">
      ...
      <div className="flex flex-col self-stretch rounded-lg ">
        <div className="flex justify-center self-stretch h-12 bg-gray-50 border-b border-slate-200">
          ...
          <div className="w-[176px] flex items-center px-4"><span className="font-normal text-sm text-gray-700">Leave Type</span></div>
        ...
        <div>
          {leaveHistoryData.map((leave,index) => (
            ...
            <div key={leave.id} className="flex justify-center self-stretch h-auto min-h-[55px] border-b border-slate-200 last:border-b-0">
              ...
              <div className="w-[176px] flex items-center px-4 py-2"><span className="font-normal text-sm text-gray-700">{leave.leaveType}</span></div>
