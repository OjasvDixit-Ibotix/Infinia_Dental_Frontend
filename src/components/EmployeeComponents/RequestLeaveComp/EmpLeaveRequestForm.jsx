    ...
    return (
        <div className="flex gap-2">
            <SelectDropdown
                className="w-1/4"
                placeholder="Day"
                options={generateNumericOptions(1, 31)}
            ...
            <SelectDropdown
                className="w-1/3"
                placeholder="Year"
                options={generateNumericOptions(new Date().getFullYear() - 5, new Date().getFullYear() + 5)}
            ...
            <div className="flex flex-col lg:flex-row gap-9 mt-4">
                <div className="w-full lg:w-[580px] mt-3 flex flex-col gap-4 rounded-lg border border-[#EFCD78] bg-[rgba(239,205,120,0.02)] p-8">
                    <div className="grid grid-cols-1 md:grid-cols-3 items-center gap-x-6 gap-y-4">
                        ...
                        <div className="md:col-span-2">
                            <DateSelector date={fromDate} onDateChange={setFromDate} />
                        </div>

                        <label className="text-[#3C3C3C] font-medium">To</label>
                        <div className="md:col-span-2">
                            <DateSelector date={toDate} onDateChange={setToDate} />
                        </div>
                        ...
                        <div className="md:col-span-2">
                            <input
                                ...
                                readOnly
                                value={numberOfDays}
                                className="flex items-center px-4 py-2 rounded-[8px] border-[0.2px] border-gray-300 text-gray-500 w-full text-sm focus:outline-none bg-gray-100"
                            />
                        </div>
