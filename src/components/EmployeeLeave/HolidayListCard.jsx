...
const HolidayListCard = () => {
  ...
  return (
    <div className="relative rounded-2xl p-6 w-80 text-gray-800 overflow-hidden" style={{
        borderRadius: '20px',
  ...
  <ellipse opacity="0.14" cx="74" cy="74.5" rx="74" ry="74.5" fill="white" fill-opacity="0.7"/>
</svg></div>
